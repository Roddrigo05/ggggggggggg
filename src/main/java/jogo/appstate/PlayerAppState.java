...
public class PlayerAppState extends BaseAppState {
    ...
    private float tempoMostraVida  = 0f;
    ...
    protected void initialize(Application app) {
        ...
        //responsavel por colocar elementos no ecra
        //o guinodee adiciona o conteudo que lhe é dado em cima da imagem 3D e o asset manager carrega o texto
        HudAppState hud = new HudAppState(((SimpleApplication) app).getGuiNode(), assetManager, world);
        hud.setPlayer(player);

        //adiciona o hud e atualiza o automaticamente
    ...
    public void update(float tpf) {
        ...
        int slotSelecionado = input.consumeSlotSelection();
        if (slotSelecionado != -1) {
            player.setSlotSelecionado(slotSelecionado);
        }
